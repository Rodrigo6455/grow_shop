...
class SeedsControllerTest < ActionController::TestCase
  ...
  test "should create seed" do
    assert_difference('Seed.count') do
      post :create, seed: { costo: @seed.costo, descripcion: @seed.descripcion, image: @seed.image, nombree: @seed.nombree, raza: @seed.raza }
    end
  ...
  test "should update seed" do
    patch :update, id: @seed, seed: { costo: @seed.costo, descripcion: @seed.descripcion, image: @seed.image, nombree: @seed.nombree, raza: @seed.raza }
    assert_redirected_to seed_path(assigns(:seed))
  end
